  ...
  <el-card>
    <el-table border stripe :data="skuList" v-loading="loading">
      ...
      <el-table-column label="操作" width="250" align="center">
        <template slot-scope="{row}">
          <HintButton title="上架" v-if="row.isSale == 0" type="success" size="mini"
            icon="el-icon-top" @click="onSale(row.id)" />
          <HintButton title="下架" v-if="row.isSale == 1" type="warning" size="mini"
    ...
    <el-drawer
      ...
      <el-row class="row-images">
        ...
        <el-col :span="16">
          <el-carousel v-if="skuInfo.skuImageList" trigger="click" :autoplay="false" arrow="always" height="400" style="width: 400px">
